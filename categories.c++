...
public:
    ...
    Node* pop(Node* head, int id) {
        if(head == NULL) {
            cout<<"Empty category!"<<endl<<endl;
            return head;
        }
        else if(head->link == NULL && head->product_id == id) {
            cout<<"Product with id "<<id<<" has been successfully deleted."<<endl<<endl;
            free(head);
            return NULL;
        }
    ...
    void updatePrice(Node* head, int id) {
        ...
        if(head == NULL) {
            ...
            cin>>price;
            head->price = price;
            cout<<"Product with id "<<id<<" has been successfully updated."<<endl<<endl;
            return;
        }
        Node *first = NULL, *second = head, *third = head->link;
        while(second != NULL) {
